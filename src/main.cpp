...
const string strMessageMagic = "XenuCoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if(nHeight < 1440) // no block reward within the first 1 days (number of minutes)
        nSubsidy = 0;
    if(nHeight > 5000000) // no block reward after 9.5 years
        nSubsidy = 0;

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 60; // XenuCoin: 60 seconds
static const int64 nTargetSpacing = 60; // XenuCoin: 60 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal xenucoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "XenuCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x95ff398aa26c20d60a487c2f5b6b9c38a890356f3631b595f59892090696170f");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "NY Times: 12/20/13;  Yemen Deaths Test Claims Behind New Drone Policy";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1387599470;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 390095138;
        ...
        assert(block.hashMerkleRoot == uint256("0xe54faed792ceb1a11018bff46ee28c5fde1aafd3ba9f6d18f34c4201e5b6c25b"));
